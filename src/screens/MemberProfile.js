        ...
        <View style = {styles.container}>
            <View style = {styles.profileDetails}>
                <View style = {styles.imageContainer}>
                    <Image style = {styles.profilePic} source = {require('../../assets/geez.jpeg')}></Image>
                </View>
                <View style = {styles.profileName}>
                    <Text style = {styles.boldName}>Rashid Mugeez</Text>
                    <Text style = {styles.normalName}>Procument Manager</Text>
                </View>
            ...
            <View style = {styles.contactsContainer}>
                ...
                <View><Text>rashidmugeez@email.com</Text></View>
                </TouchableOpacity>
                </View>
